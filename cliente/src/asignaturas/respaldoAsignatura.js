              ...
              <tbody>
                {asignaturas.map((asignatura) => (
                  <tr key={asignatura.id_alumnos}>
                    <h4>{asignatura.nombre1_profesor} {asignatura.nombre2_profesor}</h4>
                    <h4>{asignatura.apellido1_profesor} {asignatura.apellido2_profesor}</h4>
                    <h4>{asignatura.telefono}</h4>
                    <h4>{asignatura.direccion}</h4>
                    <h4>{asignatura.email}</h4>
                    <h4>
                      ...
                      <Link to={`/editAlumno/${asignatura.id_asignaturas}`} className='btn btn-info'>
